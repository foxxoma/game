const fieldCreate = ()=>{
	...
	Field.coordinates[7][5].anten = true;
	Field.coordinates[7][7].generator = true;

	Field.coordinates[12][16].anten = true;
	Field.coordinates[12][18].generator = true;

	Field.coordinates[3][39].anten = true;
	Field.coordinates[3][41].generator = true;

	Field.coordinates[18][39].anten = true;
	Field.coordinates[18][41].generator = true;

	Field.coordinates[12][1].decor = true;
	Field.coordinates[12][2	].generator = true;

	Field.coordinates[18][21].decor = true;
	Field.coordinates[18][20].generator = true;


	Field.coordinates[16][45].num = 6;
	Field.coordinates[18][45].decor = true;

	Field.coordinates[3][25].decor = true;
	Field.coordinates[3][24].generator = true;
	...
	// 			if(random === 1){
	// 				Field.coordinates[y][x].generator = true
	// 			}
	// 		}
	// 	}
	// }
	...
	// 			let random = Math.floor(Math.random() * 14)
	// 			if(random === 1){
	// 				Field.coordinates[y][x].decor = true
	// 			}
	// 		}
	// 	}
	// }
